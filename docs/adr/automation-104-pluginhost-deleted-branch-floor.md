# AUTOMATION-104: remove deleted PluginHost branch counts from the historical floor
...
Evidence: comparison of the base and integrated full-unit Cobertura reports at
the revisions above. The 3293-test run had 20 failures; this
