...
the owner protocol proves input identity, run ownership, and committed results.
...
The old FsHotWatch proposal informed this narrow boundary. That ticket
was completed by Intelligence's ReportCoherence consumer gate; it is not reopened.
The producer fix belongs to the private earned-evidence acceptance and supports
