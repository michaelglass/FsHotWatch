...
The old FsHotWatch AUTOMATION-617 proposal informed this narrow boundary.
The producer must validate its own evidence without depending on downstream
coherence checks. Importing the old 23-file proposal and duplicating its broad
outcome/wire redesign was rejected.
