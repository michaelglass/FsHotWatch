...
///   folds to green. No signature can distinguish the two
...
[<CliAnalyzer("RunVerdictFoldAnalyzer",
              "Forbids folding TestResult.isPassed over a whole run's results as the run-level verdict — a zero-match project passes having verified nothing")>]
