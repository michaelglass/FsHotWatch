...
// The exhaustive table for THE per-project derivation.
//
...
//
// Replaced `TestResult.ranFullSuite : _ -> bool`, a bool with no
...
// --- RunVerdict: a content-free ✓ is unconstructible ---------
//
...
// --- a run that verified nothing is a case on the run record ---
