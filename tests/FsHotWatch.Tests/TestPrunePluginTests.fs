...
let ``the would-have-run selection drops the FULL-SUITE widening and keeps every other one`` () =
    ...
    let selection = wouldHaveRunSelection seamProjects symbolAffected Set.empty false
    ...
    let withCoarse =
        wouldHaveRunSelection seamProjects symbolAffected (Set.ofList [ "Beta.Tests" ]) false
    ...
    let withUnreadableLedger =
        wouldHaveRunSelection seamProjects symbolAffected Set.empty true
