...
let ``CheckReach.classify decides reach per failure, and refuses what it cannot decide`` () =
    ...
    test <@ CheckReach.classify (Some inFull) [ seamFailure "Beta.Tests" (Some "Beta.OneTests") ] = ReachedNoFailure @>
    ...
    test
        <@ CheckReach.classify (Some filtered) [ seamFailure "Alpha.Tests" (Some "Alpha.TwoTests") ] = ReachedNoFailure @>
