...
// ---------------------------------------------------------------------------
// THE DISEASE, IN OUR OWN TEST ASSERTIONS.
//
...
// the tests a starved drain could silently fake: pre a reader that
...
// Same disease as the drain: a failure to DO the work, rendered
...
// (no real process, no OS scheduling) — mirroring how the tracked issue tested
...
// ---------------------------------------------------------------------------
// THE REGRESSION TEST: a drain that could not finish must FAIL an
...
// ---------------------------------------------------------------------------
// the failed kill must be LOUD, not merely representable.
//
