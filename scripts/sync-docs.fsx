...
let syncPairs =
    [ "README.md", "docs/index.md"
      "src/FsHotWatch/README.md", "docs/FsHotWatch/index.md"
      "src/FsHotWatch.Cli/README.md", "docs/FsHotWatch.Cli/index.md"
      "src/FsHotWatch.TestPrune/README.md", "docs/FsHotWatch.TestPrune/index.md"
      "src/FsHotWatch.Analyzers/README.md", "docs/FsHotWatch.Analyzers/index.md"
      "src/FsHotWatch.Lint/README.md", "docs/FsHotWatch.Lint/index.md"
      "src/FsHotWatch.Fantomas/README.md", "docs/FsHotWatch.Fantomas/index.md"
      "src/FsHotWatch.Build/README.md", "docs/FsHotWatch.Build/index.md"
      "src/FsHotWatch.Coverage/README.md", "docs/FsHotWatch.Coverage/index.md"
      "src/FsHotWatch.FileCommand/README.md", "docs/FsHotWatch.FileCommand/index.md" ]
...
let syncPair (check: bool) (readmePath: string) (indexPath: string) : int =
    if not (File.Exists readmePath) then
        ...
        // When README has sync sections, replace matching sections in index.
        // When README has no sync sections, sync the full file content.
        let updatedIndex =
            if sections.IsEmpty then
                printfn "%s: full-file sync" readmePath
                readmeContent
            else
                printfn "%s: %d sync section(s): %s" readmePath sections.Count (sections.Keys |> String.concat ", ")
                replaceSections indexContent sections
