...
let allPackages =
    [ { Name = "FsHotWatch"
      ...
      { Name = "FsHotWatch.Fantomas"
        ...
        ExtraFsprojs = [] }
      { Name = "FsHotWatch.Build"
        Fsproj = "src/FsHotWatch.Build/FsHotWatch.Build.fsproj"
        DllPath = "src/FsHotWatch.Build/bin/Release/net10.0/FsHotWatch.Build.dll"
        TagPrefix = "build-v"
        ExtraFsprojs = [] }
      { Name = "FsHotWatch.Coverage"
        Fsproj = "src/FsHotWatch.Coverage/FsHotWatch.Coverage.fsproj"
        DllPath = "src/FsHotWatch.Coverage/bin/Release/net10.0/FsHotWatch.Coverage.dll"
        TagPrefix = "coverage-v"
        ExtraFsprojs = [] }
      { Name = "FsHotWatch.FileCommand"
        Fsproj = "src/FsHotWatch.FileCommand/FsHotWatch.FileCommand.fsproj"
        DllPath = "src/FsHotWatch.FileCommand/bin/Release/net10.0/FsHotWatch.FileCommand.dll"
        TagPrefix = "filecommand-v"
        ExtraFsprojs = [] } ]
