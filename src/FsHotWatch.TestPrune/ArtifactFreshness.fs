...
///        since the edit.
///
/// ## Why a copy is judged by CONTENT and never by an mtime
///
...
/// CONTENT, never mtimes. mtime is precisely what lied"* — and the
...
type Cache() =
    ...
    /// the newest — is exactly what condemned four test projects.
    ///
...
/// (it took the newest, which was net8.0, and condemned a perfect
...
/// output dir is what made the message read as nonsense.
