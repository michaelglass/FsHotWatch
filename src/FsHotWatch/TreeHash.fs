...
/// label — the same rule as the unreleased-package versioning.)
///
...
/// `5136 tests, 0 failed`, fake green, main red for hours. A fixture
...
/// MSBuild's up-to-date check believed it, and a checkout, a `touch`
