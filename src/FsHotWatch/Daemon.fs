...
type Daemon
    ...
    (
        ...
        // and the scan/change mailboxes exist — NOT here. The
    ...
    ///
    /// Exposed for the run-once merge gate, which forces a full test
