...
module TestResult =
    ...
    ///
    /// The `executedAnything` conjunct is the whole point.
...
type RunVerification =
    ...
    /// `verificationOf` returns this for any non-empty map that is
...
type TestRunCompleted =
    {
        ...
        /// a subset, OR the run executed nothing at all (before it,
