...
- AUTOMATION-564: persisted plugin-cache entries now encode repository files
...
- AUTOMATION-435: daemon construction can now omit long-lived file observation
...
- AUTOMATION-434: the macOS polling fallback now treats three consecutive snapshot
