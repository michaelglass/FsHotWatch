...
/// the human-readable half of "is my gate running my fix?".
///
/// The machine half already exists: the daemon/CLI binary-identity handshake
///compares version + content hash and restarts a stale
/// daemon, and the verdict file names its producer by hash.
