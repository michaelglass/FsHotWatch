...
/// The tracked issue fixed: the host found no such command, returned the unknown-command
...
/// the wedge classifier — `pluginOutcomeOf` fires it on `StatusView.Running
