...
type Command =
    ...
    /// The merge gate. Same checks as `check`, but the tests run
...
///
/// This is how `fshw gate` FORCES the run it demands. `set-scope full`
...
let executeCommand
    ...
    | None ->
        ...
        // reason CI can invoke the gate at all.
